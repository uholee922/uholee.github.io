...
워낙 급하게 제작하다보니 챗봇에 대한 깊, 이해 없이 프로토 타입을 작성했음에도 불구하고 거의 잘 작동하였습니다. 데이터셋이 더 제공된다면 위메프의 실제 서비스로 적용할 수 있지 않을까 조심스레 생각해봤습니다.
...
이 프로토타입을 제작하면서 그렇게 어려웠던 부분은 없었지만 굳이 하나 들자면, 의외로 raw data를 전처리하여 data로 가공할 때 적당한 커맨드를 찾는데 시간이 많이 소요되었습니다.

프로토타입 제작에는 문서 작성을 제외하고 약 8시간 정도 소요되었고, 챗봇이 무엇인지 배우면서 실제로 써볼 수 있었던 기회였던것 같습니다.
