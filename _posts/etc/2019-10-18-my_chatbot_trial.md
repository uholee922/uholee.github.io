...
챗봇을 생성하면서 에이전트를 생성하였으니 이제 인텐트만 정해주면 됩니다. 그런데 총 받은 데이터셋이 356개로 일일이 모두 학습 문과, 작업 및 매개변수, 응답을 정의하기엔 시간이 부족했습니다. 과감히 학습 문구(FAQ의 Question)와 응답(FAQ의 Answer)만을 지정하고, dialog flow의 restapi를 이용하여 챗봇을 학습시켰습니다.
